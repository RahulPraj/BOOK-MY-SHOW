        ...
        <>
            <div className="flex flex-col gap-3 lg:gap-8">
                <div className="flex  items-center gap-3 md:px-4 ">
                    ...
                    <span className=" bg-bms-700 p-1  text-xs text-white rounded ">Streaming Now</span>
                </div>
                ...
                <div className="flex flex-col-reverse  gap-3 lg:gap-5 lg:flex-col ">
                    <div className="text-white font-light flext flex-col gap-2 md:px-4 ">
                        <h4>4k &bull;English &bull; Action</h4>
                        <h4>1h 53m &bull;Action, Sci-Fi , Thriller &bull; 13+</h4>
                    </div>
                    <div className="flex items center gap-4 md:w-screen  md:px-4 lg:w-full"> 
