    ...
    return (
        <>
          ...
          <div className=" my-12 container  px-4 lg:ml-20 lg:w-2/3">
            ...
            <div className="my-8">
              <h2 className="text-gray-800 font-bold text-2xl mb-b">Cast & Crew</h2>
                <div className="flex flex-wrap gap-4 ">
                  ...
                  castName="Gal Gadot"
                  role="Wonder Woman"/>
                  <Cast image ="https://in.bmscdn.com/iedb/artist/images/website/poster/large/jared-leto-3943-24-03-2017-17-30-08.jpg" 
                  castName="Jared Leto"
                  role="the Joker"/>
                </div>
              </div>
